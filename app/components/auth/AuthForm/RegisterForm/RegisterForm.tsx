    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <Input
          ...
          size="large"
          className="!bg-background !border-border-color/30 !text-title placeholder:!text-subTitle !rounded-lg hover:!border-brand/60 focus:!border-brand !shadow-none transition-all duration-200"
        />
      </div>
      ...
      <div className="text-center space-x-1">
        <span className="text-subTitle">{t("auth.have.account")}</span>
        <button
          type="button"
