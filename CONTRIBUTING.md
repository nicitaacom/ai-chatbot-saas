...
![clone forked repository](https://i.imgur.com/Rka0tsA.png)

## Pick up any task on your choise - https://github.com/users/nicitaacom/projects/13/views/1

![pick up any task on your choise](https://i.imgur.com/Z2KSbCh.png)

## Create branch `name/feat/login-page` (feat/style/fix/upd/chore/docs)

![create branch name as task name](https://i.imgur.com/xQM2uyU.png)
...
## Keep in mind that I reject your PR if you will do all changes in 1 file (400+ lines in 1 file) OR 30+ changes in 1 commit
...
![create PR](https://i.imgur.com/8d6Uwi4.png)
...
1. Start with **add** if you need to add smth and **upd** if you need to improve and **fix** if you need to fix smth
...
Just name your branch as task name e.g `name/feat/some-feature`
...
In each (almost) folder I have `dev_readme.md` file - so you can understnad what's going on in each folder of this project
